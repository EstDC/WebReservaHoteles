...
export default function HabitacionHeroSlider() {
  ...
  return (
    ...
    >
      ...
      {/* Controles (móvil) */}
      <div className="sm:hidden flex flex-col items-center justify-center w-full mt-8 space-y-4 z-30">
        ...
        <div className="flex space-x-4 mt-2">
          <button
            onClick={prevSlide}
            className="w-10 h-10 rounded-full border-2 border-black flex items-center justify-center text-2xl bg-transparent hover:bg-black hover:text-white transition"
            aria-label="Anterior"
          >
